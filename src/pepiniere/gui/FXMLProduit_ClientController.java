...
public class FXMLProduit_ClientController implements Initializable {
...
public static int x;
 ...
 public void getShowPane() 
    {    ls.afficherBoutique();
        ...
        List <Store> ThreeProducts= new ArrayList();
        for (Store p:AllProducts )
        {
            if(i==0)
            {
                ThreeProducts.add(p);
      ...
      public Pane AddPane( List<Store> ThreeProduct)
    {
        Pane pane = new Pane();
        pane.setStyle(" -fx-background-color: white");
                    int k =1;
                    for (Store p3:ThreeProduct )
                        {
                         if(k == 1)
                            {
                                Pane pane2=new Pane();
        ...
        pane2.setStyle(" -fx-border-radius: 10;-fx-border-color: #383d3b ;-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.5), 8, 0, 0, 0); ");
                        JFXButton t=new JFXButton("Consulterrrrrrrr");  
                        t.setOnAction(e->{
                                                             x= p3.getId();

                                    try {
                                        switchToScene("ListeProduitBoutiqueClient.fxml",e);
                                    } catch (IOException ex) {
                                        Logger.getLogger(FXMLProduit_ClientController.class.getName()).log(Level.SEVERE, null, ex);
                                    }
                        ...
                        HBox hb=new HBox(t);
                           ...
                           /*     String A = p3.getImgUrl();
                              A = "C:\\wamp\\www\\pidev3info\\img\\"+A;
                                          File F1 = new File(A);
                                           Image image2 = new Image(F1.toURI().toString());
                                           
                                           
                                           System.out.println(p3.getImgUrl().toString());*/
                               ...
                               // image.setImage(image2);
                                ...
                                Label nom = new Label(p3.getUsername());
                                Text prixt=new Text(" Telephone :");
                                Label prix = new Label("             "+String.valueOf(p3.getTelephone())+" ");
                                nomt.setLayoutX(50);
                                nomt.setLayoutY(160);
                                nom.setLayoutX(100);
                                nom.setLayoutY(145);
        ...
        pane2.setStyle(" -fx-border-radius: 10 ;-fx-border-color: #383d3b ;-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.5), 8, 0, 0, 0); ");
                        ...
                        JFXButton t=new JFXButton("Consulter");    
                        t.setStyle("-fx-font-weight: bold;");
...
*/
    ...
    private void retoureAccueil(MouseEvent event) throws IOException {
        ...
        switchToScene("FXMLAcceuil_Client.fxml",event);
